                        ...
                        <div class="card-body">
                            {{-- <form  wire:submit.prevent="submit"> --}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="row form-group">
                                                ...
                                                <input type="text" class="form-control" id="cidade" aria-describedby="cidade" wire:model="cidade"  >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="row form-group">
                                                ...
                                                <input type="text" class="form-control" id="estado" aria-describedby="estado" wire:model="estado"  >
                                        ...
                                        <div class="col">
                                            <div class="row form-group">
                                                ...
                                                <input type="text" class="form-control" id="cep" aria-describedby="estado" wire:model="cep"  >
                                ...
                                <button class="btn btn-primary" wire:click="submit">
                                    <i class="fas fa-cloud-upload-alt"></i> Salvar</button>
                            {{-- </form> --}}
