<div>
    <div>
        <div wire:ignore.self  class="modal fade" id="modalOs" tabindex="-1" aria-labelledby="modalOsLabel" aria-hidden="true">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <select class="form-control" id="projeto" wire:model="cliente_id" wire:change="change" >
                                        <option></option>
                                ...
                                <div class="row form-group">
                                    ...
                                    @error('projeto_id') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="row form-group">
                                    <label for="descricaopraca">Faturamento</label>
                                    <select class="form-control" id="fatura" wire:model="fatura" >
                                        <option></option>
                                ...
                                <div class="row form-group">
                                    ...
                                    @error('hora_pausa') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="row form-group">
                                    <label for="descricaopraca">Hora Fim</label>
                                    <input type="time" class="form-control"  wire:model="hora_fim">
                                    @error('hora_fim') <span class="error">{{ $message }}</span> @enderror
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    @error('execucao') <span class="error">{{ $message }}</span> @enderror
